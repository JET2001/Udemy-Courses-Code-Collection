...
} // Different account types will have different rates of interest. So we'll leave this function empty.
...
float Account::GetInterestRate() const {
	return 0.0f; // This will not have any implementation, the interest rates are account dependent.
}
